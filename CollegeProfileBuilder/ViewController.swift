...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        editButton.tag == 0
        universities.append(University(uniName: "University of California, Berkley", location: "Berkley, California", enrollment: 37581, urlString: "https://www.berkeley.edu", image: UIImage(named: "berkeley.png")!))
